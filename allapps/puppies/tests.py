...
class GetSinglePuppyTest(TestCase):
    ...
    def test_get_valid_single_puppy(self):
        response = client.get(
            reverse('puppies:get_delete_update_puppy', kwargs={'puppy_id': self.rambo.id}))
        puppy = Puppy.objects.get(id=self.rambo.id)
    ...
    def test_get_invalid_single_puppy(self):
        response = client.get(
            reverse('puppies:get_delete_update_puppy', kwargs={'puppy_id': 30}))
...
class UpdateSinglePuppyTest(TestCase):
    ...
    def test_valid_update_puppy(self):
        response = client.put(
            reverse('puppies:get_delete_update_puppy',
                    kwargs={'puppy_id': self.muffin.id}),
            data=json.dumps(self.valid_payload),
            content_type='application/json'
        )
...
class DeleteSinglePuppyTest(TestCase):
    ...
    def test_valid_delete_puppy(self):
        response = client.delete(
            reverse('puppies:get_delete_update_puppy', kwargs={'puppy_id': self.muffin.id}))
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
